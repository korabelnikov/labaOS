...
//			dequeue();
//	}
//template<typename T> void  Queue<T>::queue(T val)
//	{
//		Node *node = new Node();
//		node->val=val;
//		node->next=NULL;
...
//	}
////win32
//template<typename T> void  Queue<T>::saveFile(char*(*toText)(T))
//	{
...
//		CloseHandle(file);
//	}
////template<typename T> static  Queue<T> *Queue<T>::openFile(T (__cdecl*)(char *))
//template<typename T> static Queue<T>*  Queue<T>::openFile(T(*fromText)(char*))
//	{
